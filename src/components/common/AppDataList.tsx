...
/**
 * Lista o tabla paginada genérica que maneja de forma unificada los estados
 * de carga, error, vacío y éxito para reutilizar en vistas de datos de la aplicación.
 */
export const AppDataList = <T,>({
  items,
  keyExtractor,
  renderItem,
  isLoading,
