...
/**
 * Interfaz que define el estado y las acciones disponibles en el store de preferencias de usuario.
 */
...
/**
 * Store global de Zustand optimizado para gestionar preferencias de usuario locales,
 * asegurando la persistencia de los cambios y la aplicación inmediata de temas y densidad visual.
 */
