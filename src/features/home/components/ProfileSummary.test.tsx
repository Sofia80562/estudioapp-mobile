...
const user: SessionUser = {
  id: 'user-1',
  name: 'Mateo Vera',
  email: 'mateo@estudioapp.local',
  roles: [{ id: 'role-1', code: 'estudiante', name: 'Estudiante' }],
  permissions: [],
};

/**
 * Suite de pruebas unitarias para el componente ProfileSummary,
 * validando la correcta representación de la identidad, roles y datos de contacto opcionales.
 */
describe('ProfileSummary', () => {
  ...
  it('shows session identity and assigned roles', () => {
    ...
    expect(screen.getByText('mateo@estudioapp.local')).toBeInTheDocument();
