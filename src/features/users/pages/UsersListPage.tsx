...
/**
 * Página de listado y gestión de usuarios del sistema de estudio.
 * Permite filtrar por estado (activos o todos), buscar por nombre o correo,
 * y gestionar la activación/desactivación de perfiles.
 */
const UsersListPage: React.FC = () => {
  ...
  // Consulta de usuarios paginada con filtros de búsqueda y estado
