...
/**
 * Componente de menú lateral de navegación administrativa, que organiza
 * las secciones y grupos de forma colapsable y accesible.
 */
export const AdminNavigation: React.FC<AdminNavigationProps> = ({ groups }) => {
