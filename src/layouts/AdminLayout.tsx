...
/**
 * Componente de diseño principal para la sección administrativa y de gestión de la aplicación,
 * configurando la navegación dividida (SplitPane), cabecera dinámica y rutas protegidas.
 */
